					...
					<div class="col-sm-5 rounded" style="background-color: #5fcb71; color: #ffffff">
						<div class="panel panel-default">
							<div class="panel-heading">
								<strong>${comment.author.firstName} ${comment.author.lastName}</strong> <span class="text-muted">commented
								<fmt:parseDate pattern="yyyy-MM-dd HH:mm:ss" value="${comment.dateCreated}" var="parsedCommentDate" />
