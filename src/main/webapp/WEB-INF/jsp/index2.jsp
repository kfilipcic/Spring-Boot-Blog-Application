            ...
            <div class="item mb-5">
                <div class="media">
                    ...
                    <div class="media-body">
                        ...
                        <div class="meta mb-1">Author: <span class="time">${post.author.firstName} ${post.author.lastName}</span><span class="date">${post.dateCreated}</span><span class="time">6 min read</span><span class="comment"><a href="#">8 comments</a></span></div>
